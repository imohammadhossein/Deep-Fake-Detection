...
> There are 3 testes CNN-Based networks ([**Efficient**](https://github.com/imohammadhossein/Deep-Fake-Detection/blob/develop/src/Efficient.ipynb "Efficient net B6 approach"), Resnet, VGG), each with different results.
> 
> 
